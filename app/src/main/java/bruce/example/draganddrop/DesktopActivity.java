...
public class DesktopActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mainPager.setAdapter(new DesktopPagerAdapter(DesktopActivity.this,
				splitItems(pageSize, loadDesktopItems()), "main"));
		
		shortcutPager = (ViewPager) findViewById(R.id.shortcut_pager);
		shortcutPager.setAdapter(new DesktopPagerAdapter(DesktopActivity.this,
				splitItems(5, makeSlots(6)), "shortcut"));
	}
